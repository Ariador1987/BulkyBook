        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            Input = new InputModel
            {
                ...
                RoleList = _roleManager.Roles
                            .Where(u => u.Name != StaticDetails.Role_User_Indi)
                            .Select(u => u.Name)
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // zakomentirama ovo da ne dodajemo odmah usere u admine
                    //await _userManager.AddToRoleAsync(user, StaticDetails.Role_Admin);

                    // ako je role null, onda je user inidividual user jer role nije bio odabran
                    if (user.Role == null)
                    {
                    ...
                    {
                        // ovdje vraćamo korisnika na stranicu ako korisnik dolazi sa naše stranice
                        if (user.Role == null)
                        {
